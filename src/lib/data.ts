    ...
    body: {
      ...
      content: {
        ...
        steps: [
          ...
          {
            step: 'Paso 4', title: 'Interacción y análisis con un compañero (Obligatorio)', duration: '15 min',
            desc: 'Analiza tus resultados con otro estudiante (presencial u online). ¡Sin esta sección la tarea no será válida y el problema no se considerará resuelto!',
            details: [
              'Tengan una llamada/sesión y revisen las diferentes preguntas que ambos hicieron.',
              'Agrega al PDF el nombre de la persona con quien trabajaste.',
              'Incluye una comparativa: qué preguntas hizo él/ella, cuáles hiciste tú, y qué preguntas pudiste haber hecho para obtener más información.',
              'Responde: ¿Consideras que lograste darle al cliente la respuesta que buscaba? ¿Qué te faltó?',
              '📌 Modalidad: Puedes agregar este análisis de forma escrita en el PDF, o bien grabar un audio (máximo 5 minutos) y simplemente incluir el link en tu PDF.',
            ],
          },
        ],
  ...
  // ── 8. RÚBRICA (Carlos Méndez) ────────────────────────
  {
    ...
    body: {
      ...
      content: {
        ...
        deliverables: [
          { emoji: '📄', text: '1. Un PDF donde coloques tus conversaciones con los clientes.' },
          { emoji: '🤝', text: '1.1 Evidencia de interacción con un compañero (deben indicar con quién trabajaron). Sin esta sección la tarea no será válida.' },
          { emoji: '⚖️', text: '2. Comparativa de preguntas (las que él/ella hizo vs tú) y qué preguntas te hicieron falta para obtener más información.' },
          { emoji: '🤔', text: '3. Reflexión: ¿lograste darle al cliente la respuesta que buscaba? ¿qué te faltó?' },
          { emoji: '🎙️', text: 'Nota: El análisis puede ser escrito o en un audio grabado de máximo 5 minutos (solo incluir el link).' },
        ],
        rubric: RUBRIC,
    ...
    body: {
      ...
      content: {
        ...
        items: [
          ...
          { emoji: '📄', label: 'PDF de conversaciones', description: 'Las 5 conversaciones completas con los clientes.', done: false },
          { emoji: '🤝', label: 'Compañero asignado', description: 'Indicar claramente en el documento el nombre del compañero con el que trabajaste. (Requisito obligatorio).', done: false },
          { emoji: '📝', label: 'Análisis y comparativa', description: 'Preguntas que te faltaron hacer, comparativa de preguntas entre tu compañero y tú, y reflexión de si le diste al cliente lo que buscaba.', done: false },
          { emoji: '🎙️', label: 'Formato del análisis (Escrito o Audio)', description: 'Si es escrito, va directo en el PDF. Si es audio, no debe tomar más de 5 minutos y solo se incluye el link.', done: false },
        ],
